...
The last component of any Power Delivery setup is a good quality PD3.1, 240 watt certified cable. Many fine cable are available but we recommend the INIU USB C to USB C Cable, 240W Fast Charging Cable for its quality and fair price.
...
On powerup, USB-C connection, or changing the switches, based on the selected voltage, the PixelBlaster will ascertain the available voltages and currents of the charger, and set the charger's profile (PDOs) at the desired voltage to the maxmium current available with priority givien to any programable voltage PDOs. Using programmable voltage (PPS/AVS) PDOs also allows for the PixelBlater to compensate for any cable losses maintaining a more accurate output voltage at your LEDs. Know your charger's capabilities before connecting your string. If your charger does not have voltage capabilities for your setting, it will default to 5 volts.
